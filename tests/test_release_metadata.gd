...
func _ready() -> void:
	...
	_expect(ProjectSettings.get_setting("application/config/version") == "1.2.0", "project version should match the release branch")
	...
	_expect("application/product_version=\"1.2.0.0\"" in presets and "include_filter=\"*.md,*.txt\"" in presets, "exports should carry the current version and include distributable license documents")

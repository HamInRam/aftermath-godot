...
const KITS := {
	...
	"stealth": {"name": "GHOST KIT", "description": "MP5SD6 + USP45 // LOW REPORT", "guns": ["hk_mp5sd6", "hk_usp45_tactical"], "reserve_magazines": 2, "cleaner_bonus": 1, "noise": 0.72, "move": 1.01, "armor": [0.7, 0.12, 20.0, false]},
}
